  ...
  return (
    <Stack alignItems={'center'} mt={'37px'} justifyContent={"center"} p={'20px'}>
      ...
      <Box position={'relative'} mb={'72px'}>
        <TextField sx={{
          input: { fontWeight: 700, border: 'none', borderRadius: '4px' }, width: { lg: '800px', xs: '350px' }, bgcolor: '#fff', borderRadius: '40px'
        }}
          height={'76px'} value={search} onChange={(e) => setSearch(e.target.value.toLowerCase())} placeholder='searchExerices' type='text'
        />
